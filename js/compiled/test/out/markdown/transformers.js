...
markdown.transformers.empty_line = (function markdown$transformers$empty_line(text,p__15256){
var map__15259 = p__15256;
...
var state = map__15259__$1;
var code = cljs.core.get.call(null,map__15259__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__15259__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
var G__15261 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__15262 = cljs.core.drop.call(null,(2),remaining);
buf = G__15261;
remaining = G__15262;
continue;
} else {
var G__15263 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__15264 = cljs.core.rest.call(null,remaining);
buf = G__15263;
remaining = G__15264;
continue;
...
markdown.transformers.heading = (function markdown$transformers$heading(text,p__15265){
var map__15268 = p__15265;
var map__15268__$1 = ((((!((map__15268 == null)))?((((map__15268.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15268.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15268):map__15268);
var state = map__15268__$1;
var next_line = cljs.core.get.call(null,map__15268__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var code = cljs.core.get.call(null,map__15268__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__15268__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var heading_anchors = cljs.core.get.call(null,map__15268__$1,new cljs.core.Keyword(null,"heading-anchors","heading-anchors",1713527866));
...
markdown.transformers.br = (function markdown$transformers$br(text,p__15270){
var map__15273 = p__15270;
var map__15273__$1 = ((((!((map__15273 == null)))?((((map__15273.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15273.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15273):map__15273);
var state = map__15273__$1;
var code = cljs.core.get.call(null,map__15273__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__15273__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state))?text:clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__15275_SHARP_){
var url = cljs.core.subs.call(null,p1__15275_SHARP_,(1),(cljs.core.count.call(null,p1__15275_SHARP_) - (1)));
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__15276_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__15276_SHARP_,(1),(cljs.core.count.call(null,p1__15276_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers._STAR_formatter_STAR_.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__15276_SHARP_,(1),(cljs.core.count.call(null,p1__15276_SHARP_) - (1))))));
return [cljs.core.str("<a href=\"mailto:"),cljs.core.str(encoded),cljs.core.str("\">"),cljs.core.str(encoded),cljs.core.str("</a>")].join('');
}))),state], null);
});
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__15277){
var map__15280 = p__15277;
var map__15280__$1 = ((((!((map__15280 == null)))?((((map__15280.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15280.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15280):map__15280);
var state = map__15280__$1;
var inline_heading = cljs.core.get.call(null,map__15280__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
markdown.transformers.open_paragraph = (function markdown$transformers$open_paragraph(text,p__15282){
var map__15285 = p__15282;
var map__15285__$1 = ((((!((map__15285 == null)))?((((map__15285.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15285.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15285):map__15285);
var state = map__15285__$1;
var eof = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__15285__$1,new cljs.core.Keyword(null,"code","code",1586293142));
...
markdown.transformers.close_paragraph = (function markdown$transformers$close_paragraph(text,p__15287){
var map__15290 = p__15287;
...
var state = map__15290__$1;
var next_line = cljs.core.get.call(null,map__15290__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
var paragraph = cljs.core.get.call(null,map__15290__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
if(cljs.core.truth_((function (){var and__6405__auto__ = paragraph;
if(cljs.core.truth_(and__6405__auto__)){
...
markdown.transformers.code = (function markdown$transformers$code(text,p__15292){
var map__15295 = p__15292;
...
var state = map__15295__$1;
var eof = cljs.core.get.call(null,map__15295__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__15295__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code__$1 = cljs.core.get.call(null,map__15295__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__15295__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
...
markdown.transformers.codeblock = (function markdown$transformers$codeblock(text,p__15297){
var map__15305 = p__15297;
...
var state = map__15305__$1;
var codeblock__$1 = cljs.core.get.call(null,map__15305__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var codeblock_end = cljs.core.get.call(null,map__15305__$1,new cljs.core.Keyword(null,"codeblock-end","codeblock-end",1507794736));
var indented_code = cljs.core.get.call(null,map__15305__$1,new cljs.core.Keyword(null,"indented-code","indented-code",-904930175));
var next_line = cljs.core.get.call(null,map__15305__$1,new cljs.core.Keyword(null,"next-line","next-line",-1187000287));
...
if(cljs.core.truth_((function (){var and__6405__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),(function (){var G__15308 = next_line;
if((G__15308 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__15308);
}
})()));
if(and__6405__auto__){
...
var vec__15309 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__15309,(0),null);
var code = cljs.core.nth.call(null,vec__15309,(1),null);
...
markdown.transformers.blockquote = (function markdown$transformers$blockquote(text,p__15312){
var map__15315 = p__15312;
var map__15315__$1 = ((((!((map__15315 == null)))?((((map__15315.cljs$lang$protocol_mask$partition0$ & (64))) || (map__15315.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__15315):map__15315);
var state = map__15315__$1;
var eof = cljs.core.get.call(null,map__15315__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__15315__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__15315__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__15315__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__6417__auto__ = code;
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
...
return (function (p1__15317_SHARP_){
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__15317_SHARP_),cljs.core.str("</ol>")].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__15322){
var vec__15323 = p__15322;
var id = cljs.core.nth.call(null,vec__15323,(0),null);
var label = cljs.core.nth.call(null,vec__15323,(1),null);
...
var vec__15332 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__15332,(0),null);
var key = cljs.core.nth.call(null,vec__15332,(1),null);
var val = cljs.core.nth.call(null,vec__15332,(2),null);
var vec__15335 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__15335,(0),null);
var next_val = cljs.core.nth.call(null,vec__15335,(1),null);
...
var vec__15341 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__15341,(0),null);
var val = cljs.core.nth.call(null,vec__15341,(1),null);
...
var G__15344 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.fromArray([key,new_val], true, false));
var G__15345 = cljs.core.rest.call(null,remain);
var G__15346 = key;
acc = G__15344;
remain = G__15345;
prev_key = G__15346;
