...
var G__15832 = o;
(G__15832[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__15834__i < G__15834__a.length) {G__15834__a[G__15834__i] = arguments[G__15834__i + 0]; ++G__15834__i;}
  args = new cljs.core.IndexedSeq(G__15834__a,0);
} 
...
var args = cljs.core.seq(arglist__15835);
...
var G__15841 = jsprops;
(G__15841["defaultValue"] = value);

(G__15841["onChange"] = ((function (G__15841,v,value,on_change){
return (function (p1__15838_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15838_SHARP_);
});})(G__15841,v,value,on_change))
);

(G__15841["ref"] = ((function (G__15841,v,value,on_change){
return (function (p1__15839_SHARP_){
return (this$["cljsInputElement"] = p1__15839_SHARP_);
});})(G__15841,v,value,on_change))
);
...
var vec__15848 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15848,(0),null);
var id = cljs.core.nth.call(null,vec__15848,(1),null);
var class$ = cljs.core.nth.call(null,vec__15848,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___15853 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___15853 == null)){
} else {
var key_15854 = temp__4661__auto___15853;
(jsprops["key"] = key_15854);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__15856 = (new reagent.impl.template.NativeWrapper());
(G__15856["name"] = c);
...
var len__7492__auto___15862 = arguments.length;
var i__7493__auto___15863 = (0);
while(true){
if((i__7493__auto___15863 < len__7492__auto___15862)){
args__7499__auto__.push((arguments[i__7493__auto___15863]));

var G__15864 = (i__7493__auto___15863 + (1));
i__7493__auto___15863 = G__15864;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15860){
var G__15861 = cljs.core.first.call(null,seq15860);
var seq15860__$1 = cljs.core.next.call(null,seq15860);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__15861,seq15860__$1);
});
...
break;
default:
var G__15868 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__15868;
continue;
...
var n__7332__auto___15871 = a.length;
var i_15872 = (0);
while(true){
if((i_15872 < n__7332__auto___15871)){
(a[i_15872] = reagent.impl.template.as_element.call(null,(a[i_15872])));
...
var a = cljs.core.into_array.call(null,s);
var n__7332__auto___15874 = a.length;
var i_15875 = (0);
while(true){
if((i_15875 < n__7332__auto___15874)){
var val_15876 = (a[i_15875]);
if((cljs.core.vector_QMARK_.call(null,val_15876)) && ((reagent.impl.template.key_from_vec.call(null,val_15876) == null))){
(o["no-key"] = true);
} else {
}

(a[i_15875] = reagent.impl.template.as_element.call(null,val_15876));

var G__15877 = (i_15875 + (1));
i_15875 = G__15877;
continue;
} else {
}
...
var ctx = ({});
var vec__15881 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__15881,(0),null);
var derefed = cljs.core.nth.call(null,vec__15881,(1),null);
...
var G__15885 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15885) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__15885){
