...
return [cljs.core.str((function (){var pred__16013 = cljs.core.instance_QMARK_;
var expr__16014 = reactive_val;
if(cljs.core.truth_(pred__16013.call(null,reagent.ratom.RAtom,expr__16014))){
return "ra";
} else {
if(cljs.core.truth_(pred__16013.call(null,reagent.ratom.RCursor,expr__16014))){
return "rc";
} else {
if(cljs.core.truth_(pred__16013.call(null,reagent.ratom.Reaction,expr__16014))){
return "rx";
} else {
if(cljs.core.truth_(pred__16013.call(null,reagent.ratom.Track,expr__16014))){
return "tr";
} else {
return "other";
}
