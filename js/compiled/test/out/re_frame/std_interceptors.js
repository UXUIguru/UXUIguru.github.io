...
var vec__16909_16912 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_16913 = cljs.core.nth.call(null,vec__16909_16912,(0),null);
var only_after_16914 = cljs.core.nth.call(null,vec__16909_16912,(1),null);
var db_changed_QMARK__16915 = (cljs.core.some_QMARK_.call(null,only_before_16913)) || (cljs.core.some_QMARK_.call(null,only_after_16914));
if(db_changed_QMARK__16915){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_16913);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_16914);
...
var map__16922 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__16922__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__16922__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__16930 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__16930__$1 = ((((!((map__16930 == null)))?((((map__16930.cljs$lang$protocol_mask$partition0$ & (64))) || (map__16930.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__16930):map__16930);
var coeffects = map__16930__$1;
var event = cljs.core.get.call(null,map__16930__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7492__auto___16933 = arguments.length;
var i__7493__auto___16934 = (0);
while(true){
if((i__7493__auto___16934 < len__7492__auto___16933)){
args__7499__auto__.push((arguments[i__7493__auto___16934]));

var G__16935 = (i__7493__auto___16934 + (1));
i__7493__auto___16934 = G__16935;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__7500__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq16932){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq16932));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__6417__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__7499__auto__ = [];
var len__7492__auto___16941 = arguments.length;
var i__7493__auto___16942 = (0);
while(true){
if((i__7493__auto___16942 < len__7492__auto___16941)){
args__7499__auto__.push((arguments[i__7493__auto___16942]));

var G__16943 = (i__7493__auto___16942 + (1));
i__7493__auto___16942 = G__16943;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7500__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__16936_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__16937_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__16937_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq16938){
var G__16939 = cljs.core.first.call(null,seq16938);
var seq16938__$1 = cljs.core.next.call(null,seq16938);
var G__16940 = cljs.core.first.call(null,seq16938__$1);
var seq16938__$2 = cljs.core.next.call(null,seq16938__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__16939,G__16940,seq16938__$2);
});
