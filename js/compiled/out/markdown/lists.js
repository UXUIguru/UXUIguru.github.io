...
return clojure.string.join.call(null,(function (){var iter__7197__auto__ = (function markdown$lists$close_lists_$_iter__8017(s__8018){
return (new cljs.core.LazySeq(null,(function (){
var s__8018__$1 = s__8018;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__8018__$1);
if(temp__4657__auto__){
var s__8018__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__8018__$2)){
var c__7195__auto__ = cljs.core.chunk_first.call(null,s__8018__$2);
var size__7196__auto__ = cljs.core.count.call(null,c__7195__auto__);
var b__8020 = cljs.core.chunk_buffer.call(null,size__7196__auto__);
if((function (){var i__8019 = (0);
while(true){
if((i__8019 < size__7196__auto__)){
var vec__8027 = cljs.core._nth.call(null,c__7195__auto__,i__8019);
var list_type = cljs.core.nth.call(null,vec__8027,(0),null);
cljs.core.chunk_append.call(null,b__8020,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''));

var G__8033 = (i__8019 + (1));
i__8019 = G__8033;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__8020),markdown$lists$close_lists_$_iter__8017.call(null,cljs.core.chunk_rest.call(null,s__8018__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__8020),null);
}
} else {
var vec__8030 = cljs.core.first.call(null,s__8018__$2);
var list_type = cljs.core.nth.call(null,vec__8030,(0),null);
return cljs.core.cons.call(null,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''),markdown$lists$close_lists_$_iter__8017.call(null,cljs.core.rest.call(null,s__8018__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__8034_SHARP_){
return (cljs.core.second.call(null,p1__8034_SHARP_) > num_indents);
...
var vec__8038 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__8038,(0),null);
var indents = cljs.core.nth.call(null,vec__8038,(1),null);
...
var vec__8044 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__8044,(0),null);
var indents = cljs.core.nth.call(null,vec__8044,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
markdown.lists.li = (function markdown$lists$li(text,p__8047){
var map__8050 = p__8047;
...
var state = map__8050__$1;
var code = cljs.core.get.call(null,map__8050__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__8050__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__8050__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__8050__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__8050__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
...
//# sourceMappingURL=lists.js.map?rel=1486506030380