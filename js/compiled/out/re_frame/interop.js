...
return [cljs.core.str((function (){var pred__8958 = cljs.core.instance_QMARK_;
var expr__8959 = reactive_val;
if(cljs.core.truth_(pred__8958.call(null,reagent.ratom.RAtom,expr__8959))){
return "ra";
} else {
if(cljs.core.truth_(pred__8958.call(null,reagent.ratom.RCursor,expr__8959))){
return "rc";
} else {
if(cljs.core.truth_(pred__8958.call(null,reagent.ratom.Reaction,expr__8959))){
return "rx";
} else {
if(cljs.core.truth_(pred__8958.call(null,reagent.ratom.Track,expr__8959))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1486506034008