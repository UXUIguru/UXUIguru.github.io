...
var vec__10381_10384 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_10385 = cljs.core.nth.call(null,vec__10381_10384,(0),null);
var only_after_10386 = cljs.core.nth.call(null,vec__10381_10384,(1),null);
var db_changed_QMARK__10387 = (cljs.core.some_QMARK_.call(null,only_before_10385)) || (cljs.core.some_QMARK_.call(null,only_after_10386));
if(db_changed_QMARK__10387){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_10385);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_10386);
...
var map__10394 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__10394__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__10394__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__10402 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__10402__$1 = ((((!((map__10402 == null)))?((((map__10402.cljs$lang$protocol_mask$partition0$ & (64))) || (map__10402.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10402):map__10402);
var coeffects = map__10402__$1;
var event = cljs.core.get.call(null,map__10402__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__7492__auto___10405 = arguments.length;
var i__7493__auto___10406 = (0);
while(true){
if((i__7493__auto___10406 < len__7492__auto___10405)){
args__7499__auto__.push((arguments[i__7493__auto___10406]));

var G__10407 = (i__7493__auto___10406 + (1));
i__7493__auto___10406 = G__10407;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq10404){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10404));
});
...
var args__7499__auto__ = [];
var len__7492__auto___10413 = arguments.length;
var i__7493__auto___10414 = (0);
while(true){
if((i__7493__auto___10414 < len__7492__auto___10413)){
args__7499__auto__.push((arguments[i__7493__auto___10414]));

var G__10415 = (i__7493__auto___10414 + (1));
i__7493__auto___10414 = G__10415;
continue;
} else {
}
break;
...
return cljs.core.get_in.call(null,new_db,p1__10408_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__10409_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__10409_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq10410){
var G__10411 = cljs.core.first.call(null,seq10410);
var seq10410__$1 = cljs.core.next.call(null,seq10410);
var G__10412 = cljs.core.first.call(null,seq10410__$1);
var seq10410__$2 = cljs.core.next.call(null,seq10410__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__10411,G__10412,seq10410__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1486506038894