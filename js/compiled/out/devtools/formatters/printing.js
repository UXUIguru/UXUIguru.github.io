...
var len__7492__auto___14061 = arguments.length;
var i__7493__auto___14062 = (0);
while(true){
if((i__7493__auto___14062 < len__7492__auto___14061)){
args__7499__auto__.push((arguments[i__7493__auto___14062]));

var G__14063 = (i__7493__auto___14062 + (1));
i__7493__auto___14062 = G__14063;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7500__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14058){
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__14059,G__14060,seq14058__$2);
});
...
if(cljs.core.truth_((function (){var or__6417__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__7023__auto__,writer__7024__auto__,opt__7025__auto__){
return cljs.core._write.call(null,writer__7024__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__6405__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__6405__auto__){
var or__6417__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14064_SHARP_){
return cljs.core.some_QMARK_.call(null,cljs.core.meta.call(null,p1__14064_SHARP_));
})))){
...
var map__14073 = opts;
var map__14073__$1 = ((((!((map__14073 == null)))?((((map__14073.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14073.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14073):map__14073);
var markup_db = cljs.core.get.call(null,map__14073__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__6417__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e14077){var e__13729__auto__ = e14077;
return false;
}})();
if(cljs.core.truth_(or__6417__auto__)){
return or__6417__auto__;
...
}catch (e14079){var e__13729__auto__ = e14079;
return false;
}}
})())){
...
var _STAR_current_state_STAR_14084 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__14085 = opts;
...
var markup_db = cljs.core.get.call(null,map__14085__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_14084;
}});
...
;
var temp__4655__auto___14090 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___14090)){
var managed_print_level_14091 = temp__4655__auto___14090;
var _STAR_print_level_STAR_14089_14092 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_14091;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_14089_14092,managed_print_level_14091,temp__4655__auto___14090,writer,opts,job_fn){
return (function (p1__14087_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14087_SHARP_,null);
});})(_STAR_print_level_STAR_14089_14092,managed_print_level_14091,temp__4655__auto___14090,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_14089_14092;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1486506051935