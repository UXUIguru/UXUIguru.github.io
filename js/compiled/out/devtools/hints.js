...
var map__14831 = top_item;
var map__14831__$1 = ((((!((map__14831 == null)))?((((map__14831.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14831.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14831):map__14831);
var file = cljs.core.get.call(null,map__14831__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14831__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14831__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e14830){var _e = e14830;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___14833 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___14833)){
var seen_errors_14834 = temp__4655__auto___14833;
if(cljs.core.truth_(seen_errors_14834.has(self))){
} else {
seen_errors_14834.add(self);

var temp__4657__auto___14835 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___14835)){
var sense_14836 = temp__4657__auto___14835;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_14836)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1486506055533